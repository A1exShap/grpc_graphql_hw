...
namespace Otus.Teaching.PromoCodeFactory.DataAccess.Migrations
{
    ...
    [Migration("20210523122639_Initial")]
            ...
            modelBuilder.Entity("Otus.Teaching.PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCodeCustomer", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_promo_code_customer");

                    b.HasIndex("CustomerId")
                        .HasDatabaseName("ix_promo_code_customer_customer_id");

                    b.HasIndex("PromoCodeId")
                        .HasDatabaseName("ix_promo_code_customer_promo_code_id");

                    b.ToTable("promo_code_customer");
                });
            ...
            modelBuilder.Entity("Otus.Teaching.PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCodeCustomer", b =>
                {
                    b.HasOne("Otus.Teaching.PromoCodeFactory.Core.Domain.PromoCodeManagement.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("fk_promo_code_customer_customers_customer_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Otus.Teaching.PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCode", "PromoCode")
                        ...
                        .HasConstraintName("fk_promo_code_customer_promo_codes_promo_code_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
